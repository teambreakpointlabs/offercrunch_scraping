...
function getTelevisionOffers(){
  ...
  var tvOffers = Array.prototype.map.call(tvOfferSections, function(tv){
     var tvOffer = {};
       ...
       var screenType = "";
       var brand = "";
       var retailer = 'tv and video direct';
      ...
      if(($(tv).text())!=null){
       ...
       //   productUrl = $(tv).find('a').attrs('href');
       // }
...
var processPage = function() {
    ...
    if (selfridgesTelevisions!=null){
      ...
      //     fs.write('./tv and video direct-television.txt', tvString + "\n", 'a');
...
casper.start("http://www.tvandvideodirect.co.uk/television/led-tv.html?limit=10&mode=list", function() {
